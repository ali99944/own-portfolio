...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-br from-[#003a78] to-[#003a78]/90 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 text-white py-12  dark:border-gray-700">
